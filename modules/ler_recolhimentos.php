<?php
    ...
    if (!$bsemResultados) {
        foreach ($data as $nix => $row) {
            ...
            $sline.= $cmd;
            $sline.= "</td>";
            $sline .= "<td scope='col' class='text-center'><label class='form-control-label text-dark text-center'>$cd_codagencia</label></td>";
            ...
            $sline .="</select>";
            $sline .= "</td>";
            $sline .= "<td scope='col' class='text-center'><label class='form-control-label text-dark text-center'>" . number_format($vl_base_calculo,2,',','.') . "</label></td>";
            $sline .= "<td scope='col' class='text-center' data-cd_tipoagencia='$cd_tipoagencia'><label class='form-control-label text-dark text-center' id='vl_baseISS-$id_agencia'>" . number_format($vl_base_calculo, 2, ',', '.') . "</label></td>";
            $sline .= "<td scope='col' class='text-center'><input type='text' class='form-control-input input-sm text-center' value='" . number_format($vl_iss_db,2,',','.') . "' readonly></td>";
            $sline .= "<td scope='col' class='text-center col-sm-auto textp'><input type='text' class='form-control input-sm text-center' value='" . number_format($vl_juros,2,',','.') . "' id = 'vl_iss-$id_agencia'></td>";
            $sline .= "<td scope='col' class='text-end'><input type='text' class='form-control input-sm  text-center' value='" . number_format($vl_multa,2,',','.') . "' id = 'vl_multa-$id_agencia'></td>";
            $sline .= "<td scope='col' class='text-end'><input type='text' class='form-control input-sm  text-center' value='" . number_format($taxa_esc,2,',','.') . "' id = 'vl_taxa_esc-$id_agencia'></td>";
            $sline .= "<td scope='col' class='text-end'><input type='text' class='form-control input-sm  text-center' value='" . number_format($vl_arredondamento,2,',','.') . "' id='vl_arredondamento-$id_agencia'></td>";
            $sline .= "<td scope='col' class='text-end'><input type='text' class='form-control input-sm  text-center' value='" . number_format($vl_descontos,2,',','.') . "' id= 'vl_descontos-$id_agencia'></td>";
            ...
            $sline .= "<td scope='col' class='text-start'>";
            $sline .= "<textarea class='form-control input-sm bg-transparent' rows='1' cols='25' id='te_justificativa-$id_agencia'>$te_justificativa</textarea></td>";
            $sline .= "<td scope='col' class='text-center'>";
